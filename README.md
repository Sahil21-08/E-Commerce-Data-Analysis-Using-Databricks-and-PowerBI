...
* 💎 **Loyalty Program Impact:** Loyalty sales accounted for **497M** across **444K** transactions, representing over 55% of total revenue. Loyalty ATV stands at **1.12K**.
* 📈 **Monthly Sales Trends:** Total sales hit peaks around March 2026 (**77M**) and August 2025 (**71M**), with loyalty sales following a steady trajectory hovering around 35M–45M monthly.
...
## 📊 Like-For-Like (LFL) Report Insights: 2026 vs 2025
...
### 🗺️ Regional & Store Format Performance

* **Regional Sales Distribution:**
* **North** leads total regional sales at **48M (+19.6% LFL growth)**.
* **West** and **South** closely follow at **37M** each (**+21.7%** and **+21.3%** growth respectively).
* **East** recorded **35M (+18.8% growth)**, while **Central** generated **29M (+16.6% growth)**.


* **Store Format Share:**
* **Supermarket** formats dominate revenue share at **62.44%**.
* **Express** stores contribute **22.22%**.
...
### 📦 Departmental & Category Insights

* **Top Performing Departments:**
* **Grocery & Staples** generated the highest overall revenue at **18.53 Cr (+19.71% sales growth)** with transaction growth of **+28.33%**.
* **Beverages** followed with **12.51 Cr (+20.34% sales growth)** and strong unit volume (+29.71%).
* **Household** achieved the highest percentage LFL growth at **+32.38% sales growth** and **+34.78% transaction growth**.


* **Category Breakdown:**
* **Sugar & Salt** leads category-level growth at **+43.95% sales growth** (+43.51% transactions).
...
Average Selling Price (ASP): 319.41

Units Per Trip (UPT): 4.14 units per transaction
